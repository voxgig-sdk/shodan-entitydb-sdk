...
class HealthCheckEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SHODAN_ENTITYDB_TEST_HEALTH_CHECK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def health_check_basic_setup(extra)
  ...
  entid_env_raw = ENV["SHODAN_ENTITYDB_TEST_HEALTH_CHECK_ENTID"]
