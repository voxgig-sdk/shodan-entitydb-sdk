...
#      offline in seeded test mode (ShodanEntitydbSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ShodanEntitydb_sdk.rb")
  SDK_CLASS = "ShodanEntitydbSDK"
