...
class EntityFullInfoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SHODANENTITYDB_TEST_ENTITY_FULL_INFO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def entity_full_info_basic_setup(extra)
  ...
  entid_env_raw = ENV["SHODANENTITYDB_TEST_ENTITY_FULL_INFO_ENTID"]
