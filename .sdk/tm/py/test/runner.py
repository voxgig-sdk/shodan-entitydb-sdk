...
class ShodanEntitydbTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShodanEntitydbTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ShodanEntitydbTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ShodanEntitydbTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
