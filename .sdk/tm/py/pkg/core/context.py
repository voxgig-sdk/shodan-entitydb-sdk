...
from projectname_sdk.core.control import ShodanEntitydbControl
...
class ShodanEntitydbContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ShodanEntitydbControl()
        ...
        if isinstance(sp, ShodanEntitydbSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ShodanEntitydbResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ShodanEntitydbResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ShodanEntitydbOperation({})
    ...
    def make_error(self, code, msg):
        return ShodanEntitydbError(code, msg, self)
