...
// ShodanEntitydb SDK utility type

class ShodanEntitydbUtility
{
    ...
    public static function copy(ShodanEntitydbUtility $src): ShodanEntitydbUtility
    {
        $u = new ShodanEntitydbUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
