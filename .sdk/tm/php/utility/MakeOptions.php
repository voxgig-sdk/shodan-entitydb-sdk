...
// ShodanEntitydb SDK utility: make_options

class ShodanEntitydbMakeOptions
{
    ...
    public static function call(ShodanEntitydbContext $ctx): array
    {
        ...
        //
        // `ShodanEntitydbSchema::optspec()` is built from the model:
        ...
        $optspec = ShodanEntitydbSchema::optspec();
