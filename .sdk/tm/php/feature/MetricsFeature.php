...
// ShodanEntitydb SDK metrics feature
...
class ShodanEntitydbMetricsFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _record(ShodanEntitydbContext $ctx, bool $ok): void
    {
