...
// ShodanEntitydb SDK audit feature
...
class ShodanEntitydbAuditFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _emit(ShodanEntitydbContext $ctx, string $outcome): void
    {
