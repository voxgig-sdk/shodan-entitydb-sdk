...
// ShodanEntitydb SDK clienttrack feature
...
class ShodanEntitydbClienttrackFeature extends ShodanEntitydbBaseFeature
{
    ...
    public function PostConstruct(ShodanEntitydbContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ShodanEntitydb-SDK';
