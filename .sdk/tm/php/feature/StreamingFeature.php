...
// ShodanEntitydb SDK streaming feature
...
class ShodanEntitydbStreamingFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _iterate(ShodanEntitydbResult $result): \Generator
    {
    ...
    private function _streamable(ShodanEntitydbContext $ctx): bool
    {
