...
// ShodanEntitydb SDK cache feature
...
class ShodanEntitydbCacheFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _through(ShodanEntitydbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
