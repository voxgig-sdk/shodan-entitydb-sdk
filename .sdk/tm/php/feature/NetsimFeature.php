...
// ShodanEntitydb SDK netsim feature
...
class ShodanEntitydbNetsimFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _simulate(ShodanEntitydbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ShodanEntitydbContext $ctx, array $applied): void
    {
        $client = $this->client;
