...
|---|---|---|
| `ts/` | @voxgig-sdk/shodan-entitydb-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/shodan-entitydb-sdk \
      --repository voxgig-sdk/shodan-entitydb-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/shodan-entitydb-sdk` shows it, and
`npm trust revoke @voxgig-sdk/shodan-entitydb-sdk --id=<id>` removes it.
