// Command ShodanEntitydb-cli is a CLI + REPL for the ShodanEntitydb SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      SHODAN_ENTITYDB_APIKEY (api key), SHODAN_ENTITYDB_BASE (base url override)")
