...
func registerSDKWords(r *eng.Registry, client *sdk.ShodanEntitydbSDK) {
...
func runOp(client *sdk.ShodanEntitydbSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
