...
// ShodanEntitydb SDK LastUpdate entity
...
class LastUpdateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LastUpdateEntity($this->_client, $opts);
    }

    /**
     * @param LastUpdate|array $args LastUpdate data (assoc-array) to store.
     */
    ...
    /**
     * @return LastUpdate|array The current LastUpdate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LastUpdate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LastUpdate fields).
     */
    ...
    /**
     * Load a single LastUpdate.
     *
     * @param LastUpdateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LastUpdateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LastUpdate|array The loaded LastUpdate as an assoc-array at the
