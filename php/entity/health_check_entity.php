...
// ShodanEntitydb SDK HealthCheck entity
...
class HealthCheckEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HealthCheckEntity($this->_client, $opts);
    }

    /**
     * @param HealthCheck|array $args HealthCheck data (assoc-array) to store.
     */
    ...
    /**
     * @return HealthCheck|array The current HealthCheck data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of HealthCheck fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of HealthCheck fields).
     */
     ...
     *
     * @param HealthCheckLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HealthCheckLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HealthCheck|array The loaded HealthCheck as an assoc-array at the
