...
// ShodanEntitydb SDK utility: graphql
//
...
class ShodanEntitydbGraphql
{
    ...
    // equivalent.
    public static function body(ShodanEntitydbContext $ctx): mixed
    {
    ...
    public static function errors(ShodanEntitydbContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
