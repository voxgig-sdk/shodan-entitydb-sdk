...
// ShodanEntitydb SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ShodanEntitydbTransformResponse
{
    public static function call(ShodanEntitydbContext $ctx): mixed
    {
        ...
        $transform = ShodanEntitydbHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
