...
// ShodanEntitydb SDK utility: fetcher

class ShodanEntitydbFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ShodanEntitydbSDK/1.0)';
    ...
    public static function call(ShodanEntitydbContext $ctx, string $fullurl, array $fetchdef): array
    {
