...
class EntityFullInfoDirectTest extends TestCase
{
    public function test_direct_load_entity_full_info(): void
    {
        $setup = entity_full_info_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-entity_full_info", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
