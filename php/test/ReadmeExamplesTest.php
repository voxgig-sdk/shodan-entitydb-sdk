...
// ShodanEntitydb SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ShodanEntitydbSDK::test)
...
{
    private const SDK_CLASS = 'ShodanEntitydbSDK';
    ...
    private const SDK_BASE = 'shodanentitydb_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../shodanentitydb_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
