...
class HealthCheckEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SHODANENTITYDB_TEST_HEALTH_CHECK_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function health_check_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SHODANENTITYDB_TEST_HEALTH_CHECK_ENTID");
