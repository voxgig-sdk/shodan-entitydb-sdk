...
class LastUpdateEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SHODAN_ENTITYDB_TEST_LAST_UPDATE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function last_update_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SHODAN_ENTITYDB_TEST_LAST_UPDATE_ENTID");
