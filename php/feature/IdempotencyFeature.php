...
// ShodanEntitydb SDK idempotency feature
...
class ShodanEntitydbIdempotencyFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _mutating(ShodanEntitydbContext $ctx): bool
    {
