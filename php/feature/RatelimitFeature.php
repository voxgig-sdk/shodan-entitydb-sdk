...
// ShodanEntitydb SDK ratelimit feature
...
class ShodanEntitydbRatelimitFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _acquire(ShodanEntitydbContext $ctx): void
    {
    ...
    private function _track(ShodanEntitydbContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
