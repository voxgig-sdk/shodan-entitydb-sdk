...
// ShodanEntitydb SDK telemetry feature
...
class ShodanEntitydbTelemetryFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _close(ShodanEntitydbContext $ctx, bool $ok): void
    {
