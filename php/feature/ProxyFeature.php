...
// ShodanEntitydb SDK proxy feature
...
class ShodanEntitydbProxyFeature extends ShodanEntitydbBaseFeature
{
    ...
    public function init(ShodanEntitydbContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ShodanEntitydbContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
