...
// ShodanEntitydb SDK timeout feature
...
class ShodanEntitydbTimeoutFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _with_timeout(ShodanEntitydbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ShodanEntitydbContext $_ctx, float $ms): void
    {
        $client = $this->client;
