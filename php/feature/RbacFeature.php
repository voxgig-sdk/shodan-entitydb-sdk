...
// ShodanEntitydb SDK rbac feature
...
class ShodanEntitydbRbacFeature extends ShodanEntitydbBaseFeature
{
    ...
    private function _required(ShodanEntitydbContext $ctx): ?string
    {
    ...
    private function _reject(ShodanEntitydbContext $ctx, string $required): void
    {
    ...
    private function _track(ShodanEntitydbContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
