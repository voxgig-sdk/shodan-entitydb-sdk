...
class ShodanEntitydbSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ShodanEntitydbHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ShodanEntitydbHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ShodanEntitydbFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ShodanEntitydbFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ShodanEntitydbUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ShodanEntitydbHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ShodanEntitydbHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ShodanEntitydbHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ShodanEntitydbError($op . "_allow",
                "ShodanEntitydbSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ShodanEntitydbHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ShodanEntitydbError("graphql_error",
                "ShodanEntitydbSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function EntityFullInfo($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_entity_full_info === null) {
                $this->_entity_full_info = new EntityFullInfoEntity($this, null);
            }
            return $this->_entity_full_info;
        }
        return new EntityFullInfoEntity($this, $data);
    }
    ...
    public function HealthCheck($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_health_check === null) {
                $this->_health_check = new HealthCheckEntity($this, null);
            }
            return $this->_health_check;
        }
        return new HealthCheckEntity($this, $data);
    }
    ...
    public function LastUpdate($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_last_update === null) {
                $this->_last_update = new LastUpdateEntity($this, null);
            }
            return $this->_last_update;
        }
        return new LastUpdateEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ShodanEntitydbSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
