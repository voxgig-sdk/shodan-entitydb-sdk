# ShodanEntitydb Golang SDK

The Golang SDK for the ShodanEntitydb API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/shodan-entitydb-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/shodan-entitydb-sdk=../path/to/github.com/voxgig-sdk/shodan-entitydb-sdk
```
...
All entities implement the `ShodanEntitydbEntity` interface.
...
```
github.com/voxgig-sdk/shodan-entitydb-sdk/
├── shodan-entitydb.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/shodan-entitydb-sdk`) re-exports everything needed
