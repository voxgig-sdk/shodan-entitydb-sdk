...
```bash
go mod edit -replace github.com/voxgig-sdk/shodan-entitydb-sdk/go=../path/to/github.com/voxgig-sdk/shodan-entitydb-sdk/go
```
...
```
github.com/voxgig-sdk/shodan-entitydb-sdk/go/
...
The root package (`github.com/voxgig-sdk/shodan-entitydb-sdk/go`) re-exports everything needed
