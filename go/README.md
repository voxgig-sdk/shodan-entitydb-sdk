...
## Install
```bash
go get github.com/voxgig-sdk/shodan-entitydb-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/shodan-entitydb-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/shodan-entitydb-sdk/go=../shodan-entitydb-sdk/go
```
