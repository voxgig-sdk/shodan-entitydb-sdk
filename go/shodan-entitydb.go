...
// instead of `sdk.NewShodanEntitydbSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ShodanEntitydbSDK  { return NewShodanEntitydbSDK(nil) }
func Test() *ShodanEntitydbSDK { return TestSDK(nil, nil) }
