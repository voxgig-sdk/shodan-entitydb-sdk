# ShodanEntitydb Golang SDK Reference

Complete API reference for the ShodanEntitydb Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ShodanEntitydbSDK`
...
#### `Entity(data map[string]any) ShodanEntitydbEntity`

Create a new `Entity` entity instance. Pass `nil` for no initial data.

#### `EntityFullInfo(data map[string]any) ShodanEntitydbEntity`

Create a new `EntityFullInfo` entity instance. Pass `nil` for no initial data.

#### `HealthCheck(data map[string]any) ShodanEntitydbEntity`

Create a new `HealthCheck` entity instance. Pass `nil` for no initial data.

#### `LastUpdate(data map[string]any) ShodanEntitydbEntity`
