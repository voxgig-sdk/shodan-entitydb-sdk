...
func NewLastUpdateEntity(client *core.ShodanEntitydbSDK, entopts map[string]any) *LastUpdateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LastUpdateEntity) GetName() string { return e.name }
...
func (e *LastUpdateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LastUpdateEntity) Deleted() bool {
	return e.deleted
}


func (e *LastUpdateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLastUpdateEntity(e.client, opts)
}

func (e *LastUpdateEntity) Data(args ...any) any {
...
func (e *LastUpdateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LastUpdate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LastUpdateEntity) DataTyped(data ...LastUpdate) LastUpdate {
	if len(data) > 0 {
		return typedFrom[LastUpdate](e.Data(asMap(data[0])))
	}
	return typedFrom[LastUpdate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LastUpdate (all fields
// optional at the wire level).
func (e *LastUpdateEntity) MatchTyped(match ...LastUpdate) LastUpdate {
	if len(match) > 0 {
		return typedFrom[LastUpdate](e.Match(asMap(match[0])))
	}
	return typedFrom[LastUpdate](e.Match())
}
...
func (e *LastUpdateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LastUpdateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LastUpdateLoadMatch and returns an LastUpdate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LastUpdateEntity) LoadTyped(reqmatch LastUpdateLoadMatch, ctrl map[string]any) (LastUpdate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return LastUpdate{}, err
	}
	return typedFrom[LastUpdate](res), nil
}



func (e *LastUpdateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LastUpdateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LastUpdateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LastUpdateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LastUpdateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
