...
type EntityFullInfoEntity struct {
	name    string
	client  *core.ShodanEntitydbSDK
...
func NewEntityFullInfoEntity(client *core.ShodanEntitydbSDK, entopts map[string]any) *EntityFullInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EntityFullInfoEntity) GetName() string { return e.name }
...
func (e *EntityFullInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EntityFullInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *EntityFullInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEntityFullInfoEntity(e.client, opts)
}

func (e *EntityFullInfoEntity) Data(args ...any) any {
...
func (e *EntityFullInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EntityFullInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EntityFullInfoEntity) DataTyped(data ...EntityFullInfo) EntityFullInfo {
	if len(data) > 0 {
		return typedFrom[EntityFullInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[EntityFullInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EntityFullInfo (all fields
// optional at the wire level).
func (e *EntityFullInfoEntity) MatchTyped(match ...EntityFullInfo) EntityFullInfo {
	if len(match) > 0 {
		return typedFrom[EntityFullInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[EntityFullInfo](e.Match())
}
...
func (e *EntityFullInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EntityFullInfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EntityFullInfoLoadMatch and returns an EntityFullInfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EntityFullInfoEntity) LoadTyped(reqmatch EntityFullInfoLoadMatch, ctrl map[string]any) (EntityFullInfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EntityFullInfo{}, err
	}
	return typedFrom[EntityFullInfo](res), nil
}



func (e *EntityFullInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EntityFullInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EntityFullInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EntityFullInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EntityFullInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
