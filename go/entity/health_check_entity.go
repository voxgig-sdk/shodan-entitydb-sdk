...
func NewHealthCheckEntity(client *core.ShodanEntitydbSDK, entopts map[string]any) *HealthCheckEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HealthCheckEntity) GetName() string { return e.name }
...
func (e *HealthCheckEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HealthCheckEntity) Deleted() bool {
	return e.deleted
}


func (e *HealthCheckEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHealthCheckEntity(e.client, opts)
}

func (e *HealthCheckEntity) Data(args ...any) any {
...
func (e *HealthCheckEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an HealthCheck; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HealthCheckEntity) DataTyped(data ...HealthCheck) HealthCheck {
	if len(data) > 0 {
		return typedFrom[HealthCheck](e.Data(asMap(data[0])))
	}
	return typedFrom[HealthCheck](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through HealthCheck (all fields
// optional at the wire level).
func (e *HealthCheckEntity) MatchTyped(match ...HealthCheck) HealthCheck {
	if len(match) > 0 {
		return typedFrom[HealthCheck](e.Match(asMap(match[0])))
	}
	return typedFrom[HealthCheck](e.Match())
}
...
func (e *HealthCheckEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HealthCheckEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HealthCheckLoadMatch and returns an HealthCheck. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HealthCheckEntity) LoadTyped(reqmatch HealthCheckLoadMatch, ctrl map[string]any) (HealthCheck, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return HealthCheck{}, err
	}
	return typedFrom[HealthCheck](res), nil
}



func (e *HealthCheckEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *HealthCheckEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HealthCheckEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HealthCheckEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HealthCheckEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
