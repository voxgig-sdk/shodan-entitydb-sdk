...
class HealthCheckEntity extends ShodanEntitydbEntityBase_1.ShodanEntitydbEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'health_check';
        this.name_ = 'health_check';
        this.Name = 'HealthCheck';
    }
    make() {
        return new HealthCheckEntity(this._client, this.entopts());
    }
