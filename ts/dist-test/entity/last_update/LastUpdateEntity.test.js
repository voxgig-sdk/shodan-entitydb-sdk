...
(0, node_test_1.describe)('LastUpdateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'last_update.' + op, live))
                return;
        }
        ...
        let last_update_ref01_data = Object.values(setup.data.existing.last_update)[0];
        // LOAD
        const last_update_ref01_ent = client.LastUpdate();
        const last_update_ref01_match_dt0 = {};
        const last_update_ref01_data_dt0 = (await last_update_ref01_ent.load(last_update_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != last_update_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/last_update/LastUpdateTestData.json');
    ...
    let idmap = transform(['last_update01', 'last_update02', 'last_update03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['SHODAN_ENTITYDB_TEST_LAST_UPDATE_ENTID'];
...
//# sourceMappingURL=LastUpdateEntity.test.js.map