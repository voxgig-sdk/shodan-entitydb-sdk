...
(0, node_test_1.describe)('LastUpdateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-last_update', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-last_update', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SHODAN_ENTITYDB_TEST_LAST_UPDATE_ENTID'];
...
//# sourceMappingURL=LastUpdateDirect.test.js.map