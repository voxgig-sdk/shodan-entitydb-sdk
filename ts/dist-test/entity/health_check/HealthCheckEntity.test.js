...
(0, node_test_1.describe)('HealthCheckEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'health_check.' + op, live))
                return;
        }
        ...
        let health_check_ref01_data = Object.values(setup.data.existing.health_check)[0];
        // LOAD
        const health_check_ref01_ent = client.HealthCheck();
        const health_check_ref01_match_dt0 = {};
        const health_check_ref01_data_dt0 = (await health_check_ref01_ent.load(health_check_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != health_check_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/health_check/HealthCheckTestData.json');
    ...
    let idmap = transform(['health_check01', 'health_check02', 'health_check03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=HealthCheckEntity.test.js.map