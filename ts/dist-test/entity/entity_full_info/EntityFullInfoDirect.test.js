...
(0, node_test_1.describe)('EntityFullInfoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ShodanEntitydbSDK({
    ...
    (0, node_test_1.test)('direct-load-entity_full_info', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-entity_full_info', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SHODAN_ENTITYDB_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ShodanEntitydbSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SHODAN_ENTITYDB_TEST_ENTITY_FULL_INFO_ENTID'];
    ...
    const client = new __1.ShodanEntitydbSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=EntityFullInfoDirect.test.js.map