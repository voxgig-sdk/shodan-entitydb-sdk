...
function envOverride(m) {
    if ('TRUE' === process.env.SHODAN_ENTITYDB_TEST_LIVE ||
        'TRUE' === process.env.SHODAN_ENTITYDB_TEST_OVERRIDE) {
    ...
    m.SHODAN_ENTITYDB_TEST_EXPLAIN = process.env.SHODAN_ENTITYDB_TEST_EXPLAIN || m.SHODAN_ENTITYDB_TEST_EXPLAIN;
    return m;
}
