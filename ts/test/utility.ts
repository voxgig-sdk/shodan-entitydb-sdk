...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.SHODANENTITYDB_TEST_LIVE ||
    'TRUE' === process.env.SHODANENTITYDB_TEST_OVERRIDE
  ) {
  ...
  m.SHODANENTITYDB_TEST_EXPLAIN = process.env.SHODANENTITYDB_TEST_EXPLAIN || m.SHODANENTITYDB_TEST_EXPLAIN
