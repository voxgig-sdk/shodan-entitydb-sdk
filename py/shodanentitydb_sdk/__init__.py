...
from shodanentitydb_sdk.utility import register

# Load features
from shodanentitydb_sdk.feature.base_feature import ShodanEntitydbBaseFeature
from shodanentitydb_sdk.features import _has_feature, _make_feature
...
class ShodanEntitydbSDK:
    ...
    def get_utility(self):
        return ShodanEntitydbUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ShodanEntitydbSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Entity(self, data=None) -> "EntityEntity":
        ...
        from shodanentitydb_sdk.entity.entity_entity import EntityEntity
