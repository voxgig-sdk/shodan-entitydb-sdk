...
class ShodanEntitydbTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShodanEntitydbTestRunner.getenv("SHODANENTITYDB_TEST_LIVE")
        override = ShodanEntitydbTestRunner.getenv("SHODANENTITYDB_TEST_OVERRIDE")
        ...
        explain = ShodanEntitydbTestRunner.getenv("SHODANENTITYDB_TEST_EXPLAIN")
