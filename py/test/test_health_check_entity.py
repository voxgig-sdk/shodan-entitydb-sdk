    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set SHODAN_ENTITYDB_TEST_HEALTH_CHECK_ENTID JSON to run live")
        client = setup["client"]
        ...
        health_check_ref01_data_dt0_loaded = health_check_ref01_ent.load(health_check_ref01_match_dt0, None)
...
def _health_check_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("SHODAN_ENTITYDB_TEST_HEALTH_CHECK_ENTID"))
