# ShodanEntitydb SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ShodanEntitydbSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ShodanEntitydbSDK(...) and ShodanEntitydbSDK.test(...) become
#      ShodanEntitydbSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "shodanentitydb_sdk"
_SDK_CLASS = "ShodanEntitydbSDK"
