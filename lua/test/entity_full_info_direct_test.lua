...
describe("EntityFullInfoDirect", function()
  it("should direct-load-entity_full_info", function()
    local setup = entity_full_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-entity_full_info", setup.live and "live" or "unit")
...
function entity_full_info_direct_setup(mockres)
