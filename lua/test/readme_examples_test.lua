...
local SDK_MODULE = "shodan-entitydb_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["entity"] = { ["test01"] = { id = "test01" } }, ["entity_full_info"] = { ["test01"] = { id = "test01" } }, ["health_check"] = { ["test01"] = { id = "test01" } }, ["last_update"] = { ["test01"] = { id = "test01" } } } }'
