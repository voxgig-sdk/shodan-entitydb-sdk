...
describe("LastUpdateDirect", function()
  it("should direct-load-last_update", function()
    local setup = last_update_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-last_update", setup.live and "live" or "unit")
