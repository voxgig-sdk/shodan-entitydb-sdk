...
describe("EntityEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHODANENTITYDB_TEST_ENTITY_ENTID JSON to run live")
      return
    end
...
function entity_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHODANENTITYDB_TEST_ENTITY_ENTID")
