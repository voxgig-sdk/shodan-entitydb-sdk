...
function runner.env_override(m)
  local live = runner.getenv("SHODAN_ENTITYDB_TEST_LIVE")
  local override = runner.getenv("SHODAN_ENTITYDB_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SHODAN_ENTITYDB_TEST_EXPLAIN")
