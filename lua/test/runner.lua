...
function runner.env_override(m)
  local live = runner.getenv("SHODANENTITYDB_TEST_LIVE")
  local override = runner.getenv("SHODANENTITYDB_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SHODANENTITYDB_TEST_EXPLAIN")
