...
describe("LastUpdateEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHODAN_ENTITYDB_TEST_LAST_UPDATE_ENTID JSON to run live")
      return
    end
...
function last_update_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHODAN_ENTITYDB_TEST_LAST_UPDATE_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["SHODAN_ENTITYDB_TEST_LAST_UPDATE_ENTID"])
