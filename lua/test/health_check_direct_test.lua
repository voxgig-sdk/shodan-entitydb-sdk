...
describe("HealthCheckDirect", function()
  it("should direct-load-health_check", function()
    local setup = health_check_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-health_check", setup.live and "live" or "unit")
