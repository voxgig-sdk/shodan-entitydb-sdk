...
local EntityFullInfoEntity = {}
EntityFullInfoEntity.__index = EntityFullInfoEntity


function EntityFullInfoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EntityFullInfoEntity)
  self._name = "entity_full_info"
  self._client = client
...
function EntityFullInfoEntity:get_name()
  return self._name
end


function EntityFullInfoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EntityFullInfoEntity.new(self._client, opts)
end
...
function EntityFullInfoEntity:mark_deleted()
  self._deleted = true
end


function EntityFullInfoEntity:deleted()
  return true == self._deleted
end


function EntityFullInfoEntity:data_set(args)
  if args ~= nil then
...
function EntityFullInfoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EntityFullInfoEntity:match_set(args)
  if args ~= nil then
...
function EntityFullInfoEntity:match_get()
...
function EntityFullInfoEntity:stream(action, args, callopts)
...
---@param reqmatch EntityFullInfoLoadMatch
---@param ctrl? table
---@return EntityFullInfo
---@return string? err
function EntityFullInfoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EntityFullInfoEntity:_run_op(ctx, post_done)
  local utility = self._utility
