...
local LastUpdateEntity = {}
LastUpdateEntity.__index = LastUpdateEntity


function LastUpdateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LastUpdateEntity)
  self._name = "last_update"
  self._client = client
...
function LastUpdateEntity:get_name()
  return self._name
end


function LastUpdateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LastUpdateEntity.new(self._client, opts)
end
...
function LastUpdateEntity:mark_deleted()
  self._deleted = true
end


function LastUpdateEntity:deleted()
  return true == self._deleted
end


function LastUpdateEntity:data_set(args)
  if args ~= nil then
...
function LastUpdateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LastUpdateEntity:match_set(args)
  if args ~= nil then
...
function LastUpdateEntity:match_get()
...
function LastUpdateEntity:stream(action, args, callopts)
...
---@param reqmatch LastUpdateLoadMatch
---@param ctrl? table
---@return LastUpdate
---@return string? err
function LastUpdateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function LastUpdateEntity:_run_op(ctx, post_done)
  local utility = self._utility
